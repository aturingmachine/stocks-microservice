package solstice.bootcamp.stocksapi.exception;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleSqlError(BadSqlGrammarException e) {
    String error = "Could not create SQL statement, check request";
    return buildResponseEntity(new ApiException(HttpStatus.BAD_REQUEST, error, e));
  }
